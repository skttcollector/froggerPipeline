...
class SaveNewAssetUI(object):
    def __init__(self, filePath=None, selectionBased=False, *args):
        ...
        if not self.pp.compatible:
            self.filepath = "X:/Production/Assets/3D/Character/Cloud/Animation/Work/Maya/scenes/Cloud_main_Modeling_Work_v0001.mb"
    ...
    def save_file(self, *args):
        ...
        if assettype == "Stages":
            basepath = "X:/Production/Stages"
        else:
            basepath = "X:/Production/Assets/3D/{0}".format(assettype)
