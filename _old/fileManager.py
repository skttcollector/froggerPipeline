...
# TODO
# image?  
# deal with someone writing over a file . . . (allow a version up to replace)
...
def file_UI_create(*args):
    ...
    widgets["assetsTab"] = cmds.tabLayout(w=aw,h=430)
...
def populate_files(*args):
    ...
    if assetFiles:
        for file in assetFiles:
            cmds.textScrollList(widgets["filesTSL"], e=True, a=os.path.basename(file))
    else:
